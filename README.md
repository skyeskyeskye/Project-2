## Red Team Vs. Blue Team Project for UPenn Cybersecurity Bootcamp

In this project, I had access to an insecure web server virtual machine which served as a target, to a Kali Linux virtual machine which served as the attacker, and to a Linux machine running our ELK server to collect data from the targeted web server.

I've uploaded PDFs for the deliverables from day 1 and day 2 of the project. Finally, I finished a slideshow going over the entirety of the project.

Below you will find the outline of this unit:
